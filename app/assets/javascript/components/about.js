      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-4 col-sm-6 col-lg-4">
            <div className="inner-wrap">
              <div className="img-wrap">
                <img src={require("../../images/bootstrap.png")} alt="bootstarp-logo" />
              </div>
              <div className="desc-wrap">
          ...
          <div className="col-md-4 col-sm-6 col-lg-4">
            <div className="inner-wrap">
              <div className="img-wrap">
                <img src={require("../../images/sass.png")} alt="sass-logo" />
              </div>
              <div className="desc-wrap">
          ...
          <div className="col-md-4 col-sm-6 col-lg-4">
            <div className="inner-wrap js-inner-wrap">
              <div className="img-wrap">
                <img src={require("../../images/js-logo.png")} alt="js-logo" />
              </div>
              <div className="desc-wrap">
          ...
          <div className="col-md-4 col-sm-6 col-lg-4">
            <div className="inner-wrap js-inner-wrap">
              <div className="img-wrap">
                <img src={require("../../images/html-5-logo.png")} alt="html-logo" />
              </div>
              <div className="desc-wrap">
          ...
          <div className="col-md-4 col-sm-6 col-lg-4">
            <div className="inner-wrap js-inner-wrap">
              <div className="img-wrap">
                <img src={require("../../images/css3-logo.png")} alt="css3-logo" />
              </div>
              <div className="desc-wrap">
